...
public class AndroidAudioRecorder {
    ...
    protected static final String EXTRA_TALE = "taleKey" ;
    ...
    public AndroidAudioRecorder setTaleKey(String taleKey) {
        this.taleKey = taleKey;
        return this;
    }
    ...
    public void record() {
        ...
        intent.putExtra(EXTRA_TALE, taleKey);
